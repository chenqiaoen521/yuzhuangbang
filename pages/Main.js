...
const styles = StyleSheet.create({
    ...
    noneb: { borderBottomWidth:0, marginTop:18, marginBottom:12, },    
    noneba: { borderBottomWidth:0, paddingTop:10, paddingBottom:10, },
    imgb: { width:0.1*(width-30), alignItems:'center', },
    img: { width:0.06*(width-30), height:0.06*(width-30), },
    shuru: { width:0.9*(width-30), color:'#999', /*marginTop:5, marginBottom:5,*/ height:50 },
    ...
    honetop:{ height:(height-270)*0.35},
    honemid:{ height:270, },
    honebottom:{ height:(height-270)*0.65},
