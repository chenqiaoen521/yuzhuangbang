    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={styles.text}><Text style={{color:'#999',fontSize:13,lineHeight:23}}>工程施工下设人工费、材料费、机械费、其他直接费等四个明细。其中人工费核算一线工人工资、津贴、伙食、补助，但不包括保险，一线工人保险在间接费里核算；材料费核算构成工程实体的材料耗用，其中包括快拆组件租费、脚手架子管租费等外租材料以及分包部分的核算，如护坡、降水、防水等；机械费核算大型推土机、压路机、两头忙、蛤蟆夯、汽车泵、砼泵、外用电梯、塔吊等的租费，包括给这些机械的加油机维修养护费；其他直接费主要核算不能区分开以上三种费用的支出，但是构成工程项目实体的支出，如：土方的二次搬运费、工程用水费、电费等。
